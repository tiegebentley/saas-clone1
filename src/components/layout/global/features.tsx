    ...
    return (
        <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
            <div className="px-8">
                ...
                <p className="mt-4 text-sm sm:text-base leading-7 max-w-2xl mx-auto px-4 text-center">
                    From AI SaaS to Advanced AI Agents
                </p>
            </div>
...
export const SkeletonThree = () => {
    return (
        <a
            href="https://www.youtube.com/watch?v=R55_zwlx-pY"
            target="__blank"
